...
import people_service_pb2 as people__service__pb2
...
class PeopleServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListPersons = channel.unary_unary(
                ...
                request_serializer=people__service__pb2.Empty.SerializeToString,
                response_deserializer=people__service__pb2.PersonList.FromString,
                )
        self.GetPerson = channel.unary_unary(
                '/person.PeopleService/GetPerson',
                request_serializer=people__service__pb2.PersonIdRequest.SerializeToString,
                response_deserializer=people__service__pb2.PersonResponse.FromString,
                )
        self.CreatePerson = channel.unary_unary(
                '/person.PeopleService/CreatePerson',
                request_serializer=people__service__pb2.PersonRequest.SerializeToString,
                response_deserializer=people__service__pb2.PersonIdResponse.FromString,
                )
        self.UpdatePerson = channel.unary_unary(
                '/person.PeopleService/UpdatePerson',
                request_serializer=people__service__pb2.UpdatePersonRequest.SerializeToString,
                response_deserializer=people__service__pb2.Empty.FromString,
                )
        ...
        self.SearchPerson = channel.unary_unary(
                ...
                request_serializer=people__service__pb2.SearchRequest.SerializeToString,
                response_deserializer=people__service__pb2.PersonResponse.FromString,
                )
        self.CountPersons = channel.unary_unary(
                '/person.PeopleService/CountPersons',
                request_serializer=people__service__pb2.Empty.SerializeToString,
                response_deserializer=people__service__pb2.CountResponse.FromString,
                )
...
def add_PeopleServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListPersons': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=people__service__pb2.Empty.FromString,
                    response_serializer=people__service__pb2.PersonList.SerializeToString,
            ),
            'GetPerson': grpc.unary_unary_rpc_method_handler(
                    servicer.GetPerson,
                    request_deserializer=people__service__pb2.PersonIdRequest.FromString,
                    response_serializer=people__service__pb2.PersonResponse.SerializeToString,
            ),
            'CreatePerson': grpc.unary_unary_rpc_method_handler(
                    servicer.CreatePerson,
                    request_deserializer=people__service__pb2.PersonRequest.FromString,
                    response_serializer=people__service__pb2.PersonIdResponse.SerializeToString,
            ),
            'UpdatePerson': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdatePerson,
                    request_deserializer=people__service__pb2.UpdatePersonRequest.FromString,
                    response_serializer=people__service__pb2.Empty.SerializeToString,
            ),
            ...
            'SearchPerson': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=people__service__pb2.SearchRequest.FromString,
                    response_serializer=people__service__pb2.PersonResponse.SerializeToString,
            ),
            'CountPersons': grpc.unary_unary_rpc_method_handler(
                    servicer.CountPersons,
                    request_deserializer=people__service__pb2.Empty.FromString,
                    response_serializer=people__service__pb2.CountResponse.SerializeToString,
            ),
    }
...
class PeopleService(object):
    ...
    def ListPersons(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/person.PeopleService/ListPersons',
            people__service__pb2.Empty.SerializeToString,
            people__service__pb2.PersonList.FromString,
    ...
    def GetPerson(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/person.PeopleService/GetPerson',
            people__service__pb2.PersonIdRequest.SerializeToString,
            people__service__pb2.PersonResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CreatePerson(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/person.PeopleService/CreatePerson',
            people__service__pb2.PersonRequest.SerializeToString,
            people__service__pb2.PersonIdResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdatePerson(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/person.PeopleService/UpdatePerson',
            people__service__pb2.UpdatePersonRequest.SerializeToString,
            people__service__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SearchPerson(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/person.PeopleService/SearchPerson',
            people__service__pb2.SearchRequest.SerializeToString,
            people__service__pb2.PersonResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CountPersons(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/person.PeopleService/CountPersons',
            people__service__pb2.Empty.SerializeToString,
            people__service__pb2.CountResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
